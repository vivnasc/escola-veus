# Hoje, em Mim · Calendário de Imagens · 30 dias

Plano dia-a-dia de **30 posts** (2026-06-01 → 2026-06-30), no formato do calendário VC Sabia.
...
- `hem-m01-15` — keywords: `mar`, `onda`, `ondas`, `costa`, `tempo`, `ciclo`, `passagem`
- `hem-m01-17` — keywords: `velas`, `altar`, `mesa`, `ritual`
- `hem-m01-18` — keywords: `planta`, `parede`, `sombras`, `olhos`
...
- `hem-m01-24` — keywords: `pé`, `pés`, `areia`, `praia`
- `hem-m01-26` — keywords: `orvalho`, `teia`, `gota`, `gotas`
...
- `hem-m02-08` — keywords: `vazio`, `vazia`, `aberto`, `aberta`, `espaço`
- `hem-m02-09` — keywords: `papel`, `dobra`, `delicado`, `frágil`
- `hem-m02-11` — keywords: `fruto`, `fruta`, `colheita`, `abundância`
...
- `hem-m02-15` — keywords: `chave`, `abrir`, `porta`, `dentro`
...
- `hem-m02-22` — keywords: `lugar`, `vazio`, `presença`, `presente`
- `hem-m02-23` — keywords: `sino`, `som`, `escutar`, `escuta`, `ouvir`
- `hem-m02-25` — keywords: `oração`, `fé`, `contar`, `conta`
