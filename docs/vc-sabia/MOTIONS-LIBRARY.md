...
- [Pássaros pequenos ao amanhecer](#passaros-pequenos-ao-amanhecer) — confianca-no-caminho · birds_dawn · 8 prompts
- [Colibris](#colibris) — presenca-leve · birds_dawn · 8 prompts
- [Andorinhas](#andorinhas) — confianca-no-caminho · wind · 8 prompts
...
- [Céu pastel com nuvens brilhantes](#ceu-pastel-com-nuvens-brilhantes) — beleza-de-existir · silence · 8 prompts
- [Montanhas etéreas](#montanhas-etereas) — confianca-no-caminho · silence · 8 prompts
- [Chá fumegante junto à janela](#cha-fumegante-junto-à-janela) — suavidade-e-descanso · silence · 8 prompts
- [Janelas abertas com cortinas leves](#janelas-abertas-com-cortinas-leves) — corpo-como-casa · wind · 8 prompts
- [Lanternas suaves](#lanternas-suaves) — beleza-de-existir · silence · 8 prompts
- [Café da manhã minimalista poético](#cafe-da-manha-minimalista-poetico) — gratidao · silence · 8 prompts
- [Livros + luz dourada](#livros-+-luz-dourada) — autoamor · silence · 8 prompts
- [Vela acesa ao nascer do sol](#vela-acesa-ao-nascer-do-sol) — presenca-leve · silence · 8 prompts

---

## Pássaros pequenos ao amanhecer

*vc-sabia: `confianca-no-caminho` · mood: `birds_dawn`*
...
*vc-sabia: `presenca-leve` · mood: `birds_dawn`*
...
*vc-sabia: `confianca-no-caminho` · mood: `wind`*
...
*vc-sabia: `presenca-leve` · mood: `wind`*
...
*vc-sabia: `suavidade-e-descanso` · mood: `wind`*
...
*vc-sabia: `beleza-de-existir` · mood: `wind`*
...
## Árvores com neblina matinal

*vc-sabia: `sonhar-com-raizes` · mood: `silence`*
...
## Rios com reflexos de luz

*vc-sabia: `confianca-no-caminho` · mood: `stream`*
...
*vc-sabia: `autoconhecimento` · mood: `silence`*
...
## Gatos ao sol da manhã

*vc-sabia: `suavidade-e-descanso` · mood: `silence`*
...
## Caminhos de floresta iluminados
...
## Luas suaves no amanhecer azul

*vc-sabia: `inteireza` · mood: `silence`*
...
## Céu pastel com nuvens brilhantes

*vc-sabia: `beleza-de-existir` · mood: `silence`*
...
*vc-sabia: `confianca-no-caminho` · mood: `silence`*
...
## Janelas abertas com cortinas leves

*vc-sabia: `corpo-como-casa` · mood: `wind`*
...
## Café da manhã minimalista poético

*vc-sabia: `gratidao` · mood: `silence`*
...
## Vela acesa ao nascer do sol

*vc-sabia: `presenca-leve` · mood: `silence`*
...
1. Abre o Midjourney (web ou Discord).
2. Copia o prompt da variante do dia.
3. Espera o still + clip vídeo (`--video` ativa o modo motion na v6/v7).
4. Download MP4 9:16.
5. Upload no Motion Library do vc-sabia. `Auto-classificar` do Claude atribui o mood.
6. No plano, clica a thumbnail da linha → grelha de thumbs → escolhe o motion.
