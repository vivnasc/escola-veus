...
/**
 * GET /api/admin/aulas/render-status?jobId=<id>
 *
 * Le o ficheiro course-assets/render-jobs/<jobId>-result.json e devolve-o.
 * O workflow GitHub Actions actualiza este ficheiro a medida que progride
...
export async function GET(req: NextRequest) {
  ...
  const resultUrl = `${base}/storage/v1/object/public/course-assets/render-jobs/${encodeURIComponent(
    jobId,
