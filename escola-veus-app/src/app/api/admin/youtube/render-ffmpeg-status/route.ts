...
/**
 * GET /api/admin/youtube/render-ffmpeg-status?jobId=<id>
 *
 * Lê o ficheiro `course-assets/render-jobs/<jobId>-result.json` (público no
 * Supabase) e devolve-o ao cliente. O workflow GitHub Actions é responsável
 * por escrever este ficheiro à medida que progride (queued → running →
 * done | failed).
 */
