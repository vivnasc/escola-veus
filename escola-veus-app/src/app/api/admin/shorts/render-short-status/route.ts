...
/**
 * GET /api/admin/shorts/render-short-status?jobId=<id>
 *
 * Lê o ficheiro course-assets/render-jobs/<jobId>-result.json (o mesmo que o
 * workflow render-short.yml vai actualizando).
 */
